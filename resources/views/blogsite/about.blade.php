...
@section('content')
    ...
    <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image:url('{{ asset("blogsite")}}/images/img_4.jpg');">
      <div class="container">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 order-md-2">
            <img src="{{ asset('blogsite')}}/images/img_1.jpg" alt="Image" class="img-fluid">
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-5 text-center">
            <img src="{{ asset('blogsite')}}/images/person_1.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5 text-center">
            <img src="{{ asset('blogsite')}}/images/person_2.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
          ...
          <div class="col-md-6 col-lg-4 mb-5 text-center">
            <img src="{{ asset('blogsite')}}/images/person_3.jpg" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
